...
/* harmony import */ var _TbUsuario_tb_usuario_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../TbUsuario/tb-usuario.service */ "./src/app/TbUsuario/tb-usuario.service.ts");
...
var TbPaiLocalizacaoService = /** @class */ (function () {
    function TbPaiLocalizacaoService(utils, http, appkeyServ, geolocation, storage, router, TbUsuario) {
        this.utils = utils;
        this.http = http;
    ...
    TbPaiLocalizacaoService.prototype.execEstouChegando = function (problema) {
        var _this = this;
        this.geolocation.getCurrentPosition().then(function (resp) {
            _this.TbUsuario.getDadosLogin().then(function (vLoginInfo) {
                if (vLoginInfo.id != "") {
                    _this.gravaLocalizacao(vLoginInfo.id, resp.coords.latitude, resp.coords.longitude, problema).then(function (msg) {
                        _this.utils.showAlert('Sucesso! / Success!', '', msg, ['OK']);
                    }).catch(function (error) {
                        _this.utils.showAlert('Erro! / Error!', '', 'Erro ao enviar sua localização. / Error sending your location.', ['OK']);
                    });
                }
                else {
                    _this.utils.showAlert('Erro! / Error!', '', 'Erro ao buscar usuário logado. Faça o login novamente! / Error searching logged in user. Please login again!', ['OK']);
            ...
            _this.utils.showAlert('Erro! / Error!', '', 'Não conseguimos receber sua localização. / We could not receive your location.', ['OK']);
        });
    };
    TbPaiLocalizacaoService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_utils_service__WEBPACK_IMPORTED_MODULE_2__["UtilsService"],
            ...
            _TbUsuario_tb_usuario_service__WEBPACK_IMPORTED_MODULE_8__["TbUsuarioService"]])
...
var TbUsuarioService = /** @class */ (function () {
    ...
    TbUsuarioService.prototype.cadastraLoginTemp = function (usuario, senha, nome, validade) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.getDadosLogin().then(function (vLoginInfo) {
                if (vLoginInfo.id != '') {
    ...
    TbUsuarioService.prototype.solicitaSenha = function (usuario) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var url = _this.utils.getWsPath() + '/Pai/solicitaResetSenha';
            var postData = {
                'appkey': _this.appKey,
                'login': usuario,
            };
    ...
    TbUsuarioService.prototype.getDadosLogin = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get('loginInfo').then(function (strLoginInfo) {
                resolve(JSON.parse(strLoginInfo));
            })
                .catch(function (err) {
                _this.limparDadosLogin();
                _this.storage.get('loginInfo').then(function (strLoginInfo) {
                    resolve(JSON.parse(strLoginInfo));
                });
            });
    ...
    TbUsuarioService.prototype.preencheDadosLogin = function (id, login, senha, nome, qr_code, validade, id_solicitacao, aprovado, is_temporario) {
        var LoginInfo = {
            "id": id,
            "login": login,
            "senha": senha,
    ...
    TbUsuarioService.prototype.limparDadosLogin = function () {
...
module.exports = "<ion-app>\n  <!--<ion-split-pane>-->\n    <ion-menu menuId=\"menu-principal\">\n      <ion-header>\n        <ion-toolbar>\n          <ion-title>Menu</ion-title>\n        </ion-toolbar>\n      </ion-header>\n      <ion-content>\n        <ion-list>\n          <ion-menu-toggle auto-hide=\"false\">\n            <ion-item routerDirection=\"root\" (click)=\"menuEstouChegando()\" class=\"item-side-menu\">\n              <ion-icon slot=\"start\" name=\"pin\"></ion-icon>\n              <ion-label>\n                Estou chegando\n                <br />\n                <small>I'm on my way</small>\n              </ion-label>\n            </ion-item>\n\n            <ion-item routerDirection=\"root\" (click)=\"menuEstouChegandoProblema()\" class=\"item-side-menu\">\n              <ion-icon slot=\"start\" name=\"alert\"></ion-icon>\n              <ion-label>\n                Estou com problema\n                <br />\n                <small>I'm in trouble</small>\n              </ion-label>\n            </ion-item>\n\n            <ion-item routerDirection=\"root\" *ngIf=\"!isTemporario\" (click)=\"menuCadTemporario()\" class=\"item-side-menu\">\n              <ion-icon slot=\"start\" name=\"person-add\"></ion-icon>\n              <ion-label>\n                Login Temporário\n                <br />\n                <small>Temporary authorization</small>\n              </ion-label>\n            </ion-item>\n\n            <ion-item routerDirection=\"root\" (click)=\"logoff()\" class=\"item-side-menu\">\n              <ion-icon slot=\"start\" name=\"power\"></ion-icon>\n              <ion-label>\n                Sair\n                <br />\n                <small>Log out</small>\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n      </ion-content>\n    </ion-menu>\n    <ion-router-outlet main></ion-router-outlet>\n  <!--</ion-split-pane>-->\n</ion-app>\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, TbUsuarioServ, router, TbPaiLocalizacao, modalController, storage, events, TbUsuario) {
        var _this = this;
        ...
        this.initializeApp();
        events.subscribe('entrouViewHomeIndex', function () {
            _this.isTemporario = true;
            _this.TbUsuario.getDadosLogin().then(function (vLoginInfo) {
    ...
    AppComponent.prototype.menuEstouChegando = function () {
        this.TbPaiLocalizacao.execEstouChegando(false);
    };
    AppComponent.prototype.menuEstouChegandoProblema = function () {
        this.TbPaiLocalizacao.execEstouChegando(true);
    };
    AppComponent.prototype.menuCadTemporario = function () {
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-button color=\"dark\" (click)=\"closeModal()\">\n        <ion-icon name=\"arrow-back\"></ion-icon>\n      </ion-button>\n    </ion-buttons>\n    <img class=\"img-logo-new\" src=\"../../assets/safe_go_logo_final-azul.png\">\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <ion-row class=\"row-user-info\">\n    <ion-col size=\"12\" text-center>\n      <img style=\"width: 80px;\" class=\"img-logo\" src=\"../../assets/person-icon.png\" />\n      <h2 class=\"label-title\">\n        LOGIN<strong>TEMPORÁRIO</strong>\n        <br />\n        <span style=\"font-size: 0.8em;\">TEMPORARY<strong>LOGIN</strong></span>\n      </h2>\n    </ion-col>\n  </ion-row>\n\n  <ion-row>\n    <ion-col size=\"10\" offset=\"1\">\n      <ion-item>\n        <ion-input placeholder=\"Usuário / User\" name=\"login\" [(ngModel)]=\"frmCadTemp.usuario\"></ion-input>\n      </ion-item>\n\n      <ion-item>\n        <ion-input placeholder=\"Senha / Password\" name=\"senha\" [(ngModel)]=\"frmCadTemp.senha\" type=\"password\"></ion-input>\n      </ion-item>\n\n      <ion-item>\n        <ion-input placeholder=\"Nome / Name\" name=\"nome\" [(ngModel)]=\"frmCadTemp.nome\"></ion-input>\n      </ion-item>\n\n      <ion-item>\n        <ion-datetime\n          placeholder=\"Validade / Expiration\"\n          name=\"validade\"\n          [(ngModel)]=\"frmCadTemp.validade\"\n          display-format=\"DD/MM/YYYY\"\n          picker-format=\"DD MMMM YYYY\"\n          month-names=\"Janeiro, Fevereiro, Março, Abril, Maio, Junho, Julho, Agosto, Setembro, Outubro, Novembro, Dezembro\"\n          (ionCancel)=\"clearInput('vcto_inicial')\"\n          cancelText=\"Limpar\"\n          doneText=\"Selecionar\"\n          min=\"{{currentDate}}\"\n          max=\"{{maxDate}}\"\n        ></ion-datetime>\n      </ion-item>\n    </ion-col>\n  </ion-row>\n\n  <ion-row>\n    <ion-col size=\"10\" offset=\"1\">\n      <ion-button class=\"send-button\" size=\"large\" type=\"button\" expand=\"block\" (click)=\"postCadTemporario()\">\n        Cadastrar / Register\n      </ion-button>\n    </ion-col>\n  </ion-row>\n</ion-content>\n"
...
module.exports = "ion-header ion-toolbar {\n  --min-height: 68px; }\n\nion-content {\n  --background: #30A1BA; }\n\n.send-button {\n  --background: #F7BD4F;\n  --color: #FFF;\n  text-transform: lowercase;\n  --border-radius: 6px; }\n\n.row-user-info {\n  padding-top: 21px; }\n\n.label-title {\n  color: #FFF;\n  letter-spacing: -2px;\n  font-size: 30px;\n  text-transform: uppercase;\n  font-family: 'Roboto-Thin'; }\n\n.label-title strong {\n    font-family: 'Roboto' !important; }\n\nion-input, ion-datetime {\n  color: #FFF;\n  font-size: 25px; }\n\nion-datetime {\n  padding-left: 0; }\n\nion-item {\n  --background: transparent;\n  --background-activated: rgba(0, 0, 0, .3);\n  --background-focused: rgba(0, 0, 0, .3); }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CadTemporarioPage = /** @class */ (function () {
    function CadTemporarioPage(modalController, utils, TbUsuarioServ) {
        ...
        var momentToday = moment__WEBPACK_IMPORTED_MODULE_5__();
        var today = momentToday.toISOString();
    ...
    CadTemporarioPage.prototype.postCadTemporario = function () {
        var _this = this;
        this.TbUsuarioServ.cadastraLoginTemp(this.frmCadTemp.usuario, this.frmCadTemp.senha, this.frmCadTemp.nome, this.utils.formatDate(this.frmCadTemp.validade, 'YYYY-MM-DD') + ' 23:59:59').then(function (msg) {
            _this.utils.showAlert('Sucesso! / Success!', '', msg, ['OK']);
            _this.closeModal();
        }).catch(function (error) {
            _this.utils.showAlert('Erro! / Error!', '', 'Erro ao cadastrar login temporário. / Error when registering temporary authorization.', ['OK']);
        });
    };
    CadTemporarioPage.prototype.clearInput = function (element) {
